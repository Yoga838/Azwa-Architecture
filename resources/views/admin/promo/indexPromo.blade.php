...
<div>
    <p class="mt-4 text-2xl text-gray-900 font-bold dark:text-white">
      ...
      <div class="min-w-full inline-block align-middle">
          ...
          <div class="overflow-hidden ">
              <table class=" min-w-full rounded-xl">
                  <thead>
                      <tr class="bg-gray-50">
                          <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-tl-xl"> Title </th>
                          <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Price </th>
                          <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Actual Price </th>
                          <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Description </th>
                          <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Status Display </th>
                          <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-tr-xl"> Actions </th>
                      </tr>
                  </thead>
        ...
        const fetchPromoData = async () => {
            ...
            data.forEach((promo) => {
                ...
                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">${promo.title}</td>
                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">${promo.price}</td>
                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">${promo.actual_price}</td>
                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">${promo.description.split(' ').slice(0, 2).join(' ')}...</td>
                    ...
                    <td class=" p-5 ">
                        <div class="flex items-center gap-1">
                            <button onclick="updatePromo(${promo.id})" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
                            ...
                            <button onclick="deletePromo(${promo.id})" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
            ...
            tableBody.innerHTML = "<tr><td colspan='6' class='p-5 text-center text-sm text-red-500'>Data gagal dimuat.</td></tr>";
            }
        };
        fetchPromoData();
    });
