            ...
            <div class="bg-white border rounded-sm border-stroke shadow-default dark:border-theme2 dark:bg-theme3">
                ...
                <form class="flex flex-col gap-5.5 p-6.5" id="portofolioForm" enctype="multipart/form-data" onsubmit="uploadPorto(event)">
                    ...
                    <div class="nama">
                        ...
                        <input type="text" placeholder="Masukkan nama" id="nama" name="name" class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-white dark:text-white dark:focus:border-primary"/>
                    </div>
                    <div class="tipe">
                        <label class="block mb-3 text-sm font-medium text-black dark:text-white">
                            Tipe
                        </label>
                        <select id="tipe" class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-whiter dark:focus:border-primary">
