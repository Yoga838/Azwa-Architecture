        ...
        <div class="flex flex-wrap -m-4 text-center">
          <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div class="border-2 border-theme3 dark:border-white px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
              ...
              <h2 class="title-font font-medium text-3xl text-gray-900 dark:text-white">{{$portofolio}}</h2>
          ...
          <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div class="border-2 border-theme3 dark:border-white px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
              ...
              <h2 class="title-font font-medium text-3xl text-gray-900 dark:text-white">{{$promos}}</h2>
          ...
          <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div class="border-2 border-theme3 dark:border-white px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
              ...
              <h2 class="title-font font-medium text-3xl text-gray-900 dark:text-white">{{$testimoni}}</h2>
