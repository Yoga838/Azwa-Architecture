<nav 
    ...
    class="fixed top-0 w-screen z-999"
>
        ...
        <div class="hidden lg:block">
            <ul class="flex space-x-12 text-white">
                ...
                <li class="relative group ">
                    ...
                    <ul class="absolute invisible w-24 mt-2 transition-all rounded-lg shadow-lg opacity-0 bg-landing-brown-3 group-hover:opacity-100 group-hover:visible">
    ...
    <div 
        ...
        class="fixed inset-0 z-40 w-screen h-screen p-4 bg-landing-brown-3"
    >
        ...
        <div class="fixed inset-0 flex items-center justify-center w-screen h-screen">
            <div>
                <div class="py-10">
                    <ul class="space-y-6 text-center text-white">
                        <li class="">
                        ...
                        <li class="" x-data="{ selected: null }">
                            ...
                            {{-- Dropdown --}}
                            <div 
                                class="mt-6 overflow-hidden transform translate"
                                :class="selected === 'layanan' ? 'block' : 'hidden'"
                            >
                                <ul class="space-y-6 text-3xl font-normal transition duration-300 ease-in-out">
                                    <li>
                ...
                <div class="">
                    <div class="flex space-x-4 text-white">
                        ...
                        <div>
                            <a href="https://www.facebook.com/p/Azwa-Karya-Tama-61550597473458/">
                        ...
                        <div>
                            <a href="https://www.linkedin.com/company/azwa-architect">
                        ...
                        <div>
                            <a href="https://www.tiktok.com/@azwadesignstudio?is_from_webapp=1&sender_device=pc">
