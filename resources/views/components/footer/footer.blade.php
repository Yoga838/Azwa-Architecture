<footer class="w-screen bg-landing-black-1">
    <div class="py-15 lg:px-25 px-10">
        <div class="">
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between justify-normal">
            <div class="text-white flex items-center lg:mb-0 mb-8">
                <div>
                    <div>
                        <h3 class="lg:w-[250px] w-full">Jl. Kyai Mojo No.110, Kec. Kaliwates,  Kab. Jember, Jawa Timur 68133</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="text-white flex lg:justify-center lg:text-center lg:mb-0 mb-8">
                <div>
                    <div class="text-[20px] text-landing-gold lg:mb-5 mb-2">Info</div>
                    <div>
                        <ul>
                            <li>Tentang Kami</li>
                            <li>Portofolio</li>
            ...
            <div class="text-white flex lg:justify-center lg:text-center lg:mb-0 mb-8">
                <div>
                    <div class="text-[20px] text-landing-gold lg:mb-5 mb-2">Ikuti Kami</div>
            ...
            <div class="text-white flex lg:justify-center lg:text-center">
                <div>
                    <div class="text-[20px] text-landing-gold lg:mb-5 mb-2">Hubungi Kami</div>
