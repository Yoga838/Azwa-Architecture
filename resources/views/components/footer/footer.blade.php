<footer class="w-screen bg-landing-black-1">
    ...
    >
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between justify-normal">
            ...
            <div class="text-white flex lg:justify-center lg:text-center">
                <div>
                    ...
                    <a href="https://wa.me/62895371025425" class="w-[200px] cursor-pointer flex items-center py-[5px] px-[10px] rounded-full bg-landing-body text-landing-black-3">
                        ...
                        <p class="font-medium ms-[5px]">Konsultasi Sekarang!</p>
                    </a>
                    <a href="mailto:azwakaryatama@gmail.com" class="w-[200px] cursor-pointer mt-5 flex items-center py-[5px] px-[10px] rounded-full bg-landing-body text-landing-black-3">
                        ...
                        <p class="font-medium ms-[5px]">Hubungi Sekarang!</p>
                    </a>
                </div>
            </div>
        </div>
