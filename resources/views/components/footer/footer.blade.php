<footer class="w-screen bg-landing-black-1">
    <div class="
        py-15 
        2xl:px-30 xl:px-25 md:px-25 sm:px-10 px-10"
    >
        <div class="">
            <img src="{{ asset('assets/img/LogoAzwa.png') }}" alt="Brand" class="2xl:w-[200px] xl:w-[150px] lg:w-[150px] md:w-[150px] sm:w-[150px] w-[150px] h-auto" />
        </div>
        <div class="flex flex-col lg:flex-row lg:justify-between justify-normal" style="font-family: Poppins, sans-serif;">
            <div class="2xl:text-xl text-base text-white flex items-center lg:mb-0 mb-8">
                <div>
                    <div>
                        <h3 class="2xl:w-[300px] xl:w-[250px] lg:w-[250px] md:w-[250px] sm:w-full w-full">Jl. Kyai Mojo No.110, Kec. Kaliwates,  Kab. Jember, Jawa Timur 68133</h3>
                    </div>
                </div>
            </div>
            <div class="w-[2px] h-auto bg-white"></div>
            <div class="text-white flex lg:justify-center lg:text-center lg:mb-0 mb-8">
                <div>
                    <div class="2xl:text-[25px] xl:text-[20px] text-[20px] text-landing-gold lg:mb-5 mb-2">Info</div>
                    <div>
                        <ul class="2xl:text-xl text-base">
            ...
            <div class="text-white flex lg:justify-center lg:text-center lg:mb-0 mb-8">
                <div>
                    <div class="2xl:text-[25px] xl:text-[20px] text-[20px] text-landing-gold lg:mb-5 mb-2">Ikuti Kami</div>
                    <div class="flex space-x-4">
                        <a href="https://www.instagram.com/azwadesignstudio/" class="cursor-pointer">
                        ...
                        <a href="https://www.facebook.com/p/Azwa-Karya-Tama-61550597473458/" class="cursor-pointer">
                        ...
                        <a href="https://www.linkedin.com/company/azwa-architect" class="cursor-pointer">
                        ...
                        <a href="https://www.tiktok.com/@azwadesignstudio?is_from_webapp=1&sender_device=pc" class="cursor-pointer">
            ...
            <div class="w-[2px] h-auto bg-white"></div>
            <div class="text-white flex lg:justify-center lg:text-center">
                <div>
                    <div class="2xl:text-[25px] xl:text-[20px] text-[20px] text-landing-gold lg:mb-5 mb-2">Hubungi Kami</div>
                    <a href="https://wa.me/62895371025425" class="w-[200px] cursor-pointer flex items-center py-[5px] px-[10px] rounded-full bg-landing-body text-landing-black-3">
                        ...
                        <p class="font-medium text-sm ms-[5px]" style="font-family: Garet, sans-serif;">Konsultasi Sekarang!</p>
                    </a>
                    <a href="mailto:azwakaryatama@gmail.com" class="w-[200px] cursor-pointer mt-5 flex items-center py-[5px] px-[10px] rounded-full bg-landing-body text-landing-black-3">
                        ...
                        <p class="font-medium text-sm ms-[5px]" style="font-family: Garet, sans-serif;">Hubungi Sekarang!</p>
                    </a>
                </div>
            </div>
        </div>
