...
@section("content")
    <div class="w-screen h-screen flex bg-cover bg-center" style="background-image:url('{{ asset('assets/img/Kontak1.png') }}')">
        <div class=" flex flex-col justify-center items-center w-screen h-screen bg-black bg-opacity-30">
            <!-- Judul -->
            <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-white mt-40 md:mt-10 mb-8">Konsultasi dengan Kami</h1>
            ...
            <div class="flex flex-col sm:mt-20 w-7/12 md:flex-row">
              ...
              <div class="flex-1 space-y-4 md:ml-10 mt-10">
                ...
                <div class="flex items-center">
                  <div class="bg-theme1 flex items-center w-90 px-5 rounded-full">
                    ...
                    <p class="text-sm md:text-xl font-medium pb-1 pl-3 ">
                      <a href="mailto:azwakaryatama@gmail.com" class="text-theme3 hover:underline">azwakaryatama@gmail.com</a>
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-center">
                  <div class="bg-theme1 flex items-center w-90 px-5 rounded-full">
                    ...
                    <p class="text-sm md:text-xl font-medium pb-1 pl-3">
                      <a href="https://wa.me/62895371025425" class="text-theme3 hover:underline" target="_blank" rel="noopener noreferrer">+62 895-3710-25425</a>
                    </p>
                  </div>
                </div>
              </div>
