            ...
            <div class="flex flex-col sm:mt-20 w-7/12 md:flex-row">
              ...
              <div class="flex-1 space-y-4 md:ml-10 mt-10">
                ...
                <div class="flex items-center justify-center md:justify-normal">
                  <div class="bg-theme1 flex items-center md:w-90 px-5 rounded-full">
                    ...
                    <p class="text-sm md:text-xl font-medium pb-1 pl-3 ">
                      <a href="mailto:azwakaryatama@gmail.com" class="text-theme3 hover:underline" target="_blank" rel="noopener noreferrer">azwakaryatama@gmail.com</a>
                    </p>
                  </div>
                </div>
