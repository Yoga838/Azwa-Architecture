...
@section("content")
        ...
        <div class="pt-30">
            <div class="flex flex-wrap">
                <div class="w-full 2xl:w-1/3 xl:w-1/3 lg:w-1/3 md:w-1/3">
                    <h1 class="2xl:text-5xl xl:text-5xl lg:text-4xl md:text-4xl text-3xl font-bold md:text-start text-center text-theme2" style="font-family: League Spartan, sans-serif;">Portofolio Kami</h1>
                </div>
                            ...
                            <div class="relative w-full h-auto mb-4 group rounded-3xl overflow-hidden">
                                ...
                                <div class="p-4 absolute inset-0 bg-white bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <span class="text-theme3">
                                        <div class="w-full h-full transform translate-y-5 group-hover:translate-y-0 transition-transform duration-300" style="font-family: Poppins, sans-serif;">
                                            <p class="lg:text-2xl text-xl" style="font-family: Poppins, sans-serif;">{{ $porto->category }}</p>
                                            <div class="absolute inset-0 flex justify-center items-center w-full h-full">
                                                <span>
                                                    <p class="mb-2 lg:text-3xl md:text-2xl text-xl font-bold" style="font-family: League Spartan, sans-serif;">{{ $porto->name }}</p>
                                                    <div class="">
                                                        <span class="flex items-center space-x-2 mb-2" style="font-family: Poppins, sans-serif;">
                                                            ...
                                                            <p class="lg:text-2xl text-xl">Indonesia</p>
                                                        </span>
                                                        <span class="flex items-center space-x-2" style="font-family: Poppins, sans-serif;">
            ...
            <div class="flex justify-center pb-30">
                <a href="https://www.instagram.com/azwadesignstudio">
                    <button class="2xl:w-[215px] w-[200px] 2xl:text-md text-base flex justify-center items-center 2xl:py-2 py-[5px] 2xl:px-2 px-[10px] rounded-full bg-landing-brown-1 text-white hover:bg-landing-brown-3 transition duration-300 ease-in-out transform hover:scale-105">
                        ...
                        <p class="font-medium ms-[5px]" style="font-family: Poppins, sans-serif;">Lihat Selengkapnya</p>
                    </button>
                </a>
            </div>
        @else
            <div class="lg:py-30 md:py-20 py-15 flex justify-center">
                <div class="text-center">
                    <div class="flex justify-center text-landing-brown-1 mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.5v5m0-8.99l.01-.011M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10"/></svg>
                    </div>
                    <h1 class="font-bold text-2xl text-landing-brown-1" style="font-family: League Spartan, sans-serif;">Tidak ada portofolio yang ditemukan.</h1>
                </div>
            </div>
        @endif
    </section>
    <section class="relative w-full 2xl:h-[700px] xl:h-[600px] h-[600px]">
        ...
        <div class="absolute inset-0 flex items-center justify-center">
            <div>
                <div class="flex justify-center items-center space-x-8" data-aos="fade-up" data-aos-duration="1000" style="font-family: Poppins, sans-serif;">
                ...
                <div class="lg:mt-20 mt-16 w-full flex justify-center text-center" data-aos="fade-up" data-aos-duration="1000">
                    <div class="lg:w-[60%] w-[75%]">
                        <h1 class="text-white 2xl:text-5xl xl:text-5xl lg:text-5xl md:text-4xl text-3xl font-bold" style="font-family: League Spartan, sans-serif;">Wujudkan Rumah Impian Anda Sekarang Juga !</h1>
                    </div>
                </div>
            </div>
        </div>
