...
@section("content")
    ...
    <div class="w-full h-full flex justify-center relative">
        ...
        <div class="py-32">
            ...
            <div class="mx-10">
                <p class="desktop:mt-40 laptop:mt-20 md:mt-20 mt-20 text-center desktop:text-7xl laptop:text-6xl md:text-4xl text-2xl font-bold text-theme1 drop-shadow-2">
                    Membangun bersama Azwa Contractor,</br>Konstruksi Berkualitas, Solusi Tanpa Batas !
                </p>
            </div>
        </div>
    </div>
    <h1 class="text-landing-gold desktop:text-5xl laptop:text-4xl md:text-2xl text-md font-bold drop-shadow-2 text-center desktop:mt-20 laptop:mt-10 lg:mt-10 md:mt-10 mt-10">KENAPA HARUS AZWA CONTRACTOR ?</h1>
    {{-- CardTag Free Design --}}
    ...
    <div class="mt-5 flex justify-center items-center desktop:px-80 laptop:px-50 md:px-30 px-5">
        <div class="w-full border desktop:px-8 laptop:px-5 md:px-5 px-5 desktop:py-6 laptop:py-4 md:py-4 py-4 bg-landing-brownLight-1 rounded-3xl">
            <div class="flex items-center">
                ...
                <div class="">
                    <h1 class="font-bold desktop:text-2xl laptop:text-xl md:text-md text-xs">REKANAN TERPERCAYA (SUPERVISI OLEH ARSITEK DAN TEKNIK SIPIL)</h1>
                    <p class="font-normal desktop:text-2xl laptop:text-xl md:text-md text-xs lg:pr-50 md:pr-10 pr-2 md:tracking-wider tracking-tight">Bekerjasama dengan rekanan terpercaya untuk memastikan setiap tahap pengerjaan bangunan memenuhi standar kualitas dan keamanan tertinggi.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-5 flex justify-center items-center desktop:px-80 laptop:px-50 md:px-30 px-5">
        <div class="w-full border desktop:px-8 laptop:px-5 md:px-5 px-5 desktop:py-6 laptop:py-4 md:py-4 py-4 bg-landing-brownLight-1 rounded-3xl">
            <div class="flex items-center">
                ...
                <div class="">
                    <h1 class="font-bold desktop:text-2xl laptop:text-xl md:text-md text-xs">DOKUMENTASI PROYEK DAN PENDAMPINGAN</h1>
                    <p class="font-normal desktop:text-2xl laptop:text-xl md:text-md text-xs lg:pr-50 md:pr-10 pr-2 md:tracking-wider tracking-tight">Memastikan setiap tahap tercatat dengan jelas dan berjalan sesuai rencana.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-5 flex justify-center items-center desktop:px-80 laptop:px-50 md:px-30 px-5">
        <div class="w-full border desktop:px-8 laptop:px-5 md:px-5 px-5 desktop:py-6 laptop:py-4 md:py-4 py-4 bg-landing-brownLight-2 rounded-3xl">
            <div class="flex items-center">
                <div class="border-0 bg-theme3 desktop:p-6 laptop:p-5 md:p-5 p-5 rounded-full lg:mx-5 mx-2">
                    <svg viewBox="0 0 1024 1024" class="desktop:w-14 laptop:w-12 md:w-12 w-12 h-full" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M182.87 146.29h585.14v292.57h73.14V73.14H109.72v877.72h402.29v-73.15H182.87z" fill="#c29844"></path><path d="M713.14 481.52L512 582.1v88.24c0 110.29 62.31 211.11 160.95 260.43l40.19 20.09 40.19-20.09c98.64-49.32 160.95-150.14 160.95-260.43V582.1L713.14 481.52z m128 188.81c0 83.12-46.18 157.84-120.52 195.01l-7.48 3.74-7.48-3.74c-74.34-37.17-120.52-111.9-120.52-195.01V627.3l128-64 128 64v43.03z" fill="#c29844"></path><path d="M657.87 683.21l-36.33 41.11 93.25 82.43 113.93-131.09-41.39-36L709.69 729zM256 256h438.86v73.14H256zM256 438.86h292.57V512H256zM256 621.71h146.29v73.14H256z" fill="#c29844"></path></g></svg>
                </div>
                <div class="">
                    <h1 class="font-bold desktop:text-2xl laptop:text-xl md:text-md text-xs">BERGARANSI</h1>
                    <p class="font-normal desktop:text-2xl laptop:text-xl md:text-md text-xs lg:pr-50 md:pr-10 pr-2 md:tracking-wider tracking-tight">Jasa kami dilengkapi garansi anti bocor dan retak struktur, memberikan jaminan ketahanan dan kualitas bangunan yang tahan lama.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="desktop:mt-70 laptop:mt-50 md:mt-50 mt-50 w-full h-full flex items-center relative">
        ...
        <div class="py-10 mt-30">
            <h1 class="font-bold desktop:text-6xl laptop:text-5xl md:text-5xl text-5xl text-theme1 drop-shadow-2 ml-10">Konstruksi Arsitektural</h1>
        </div>
    </div>
    ...
    <div class="desktop:mt-70 laptop:mt-50 md:mt-50 mt-50 w-full h-full flex items-center relative">
        ...
        <div class="py-10 mt-30">
            <h1 class="font-bold desktop:text-6xl laptop:text-5xl md:text-5xl text-5xl text-theme1 drop-shadow-2 ml-10">Konstruksi Interior</h1>
        </div>
    </div>
    ...
    <div class="flex justify-center items-center">
     ...
     {{-- Carousel Slider --}}
    <div class="w-full relative desktop:my-70 laptop:my-40 lg:my-40 md:my-20 sm:my-10 my-5">
    <div class="swiper centered-slide-carousel swiper-container relative ">
    <div class="flex justify-center mb-10 desktop:visible laptop:visible md:invisible sm:invisible invisible">
        <div class="flex items-center gap-3 mr-10">
            <div class="border bg-black-2 desktop:p-7 laptop:p-5 md:p-5 p-5 rounded-full"></div>
            <h1 class="font-semibold text-landing-brown-3 text-xs desktop:text-xl laptop:text-base md:text-xs">azwacontractor</h1>
        </div>
    </div>
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <div class="rounded-2xl desktop:h-75 laptop:h-64 md:h-64 h-64 flex justify-center items-center overflow-hidden">
    ...
    <div class="flex justify-center mt-2 desktop:visible laptop:visible md:invisible sm:invisible invisible">
        <div class="border bg-landing-brown-1 desktop:px-9 laptop:px-8 desktop:py-3 laptop:py-2 rounded-full">
