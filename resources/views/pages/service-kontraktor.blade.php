...
@section("content")
    ...
    <div class="flex items-center justify-center px-5 mt-5 desktop:px-80 laptop:px-50 md:px-30">
        <div class="w-full px-5 py-4 border desktop:px-8 laptop:px-5 md:px-5 desktop:py-6 laptop:py-4 md:py-4 bg-landing-brownLight-1 rounded-3xl">
            <div class="flex items-center">
                ...
                <div class="">
                    <h1 class="text-xs font-bold desktop:text-2xl laptop:text-xl md:text-md">REKANAN TERPERCAYA (SUPERVISI OLEH ARSITEK DAN TEKNIK SIPIL)</h1>
                    <p class="pr-2 text-xs font-normal tracking-tight desktop:text-2xl laptop:text-xl md:text-md lg:pr-50 md:pr-10 md:tracking-wider">Bekerjasama dengan rekanan terpercaya untuk memastikan setiap tahap pengerjaan bangunan memenuhi standar kualitas dan keamanan tertinggi.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center px-5 mt-5 desktop:px-80 laptop:px-50 md:px-30">
        <div class="w-full px-5 py-4 border desktop:px-8 laptop:px-5 md:px-5 desktop:py-6 laptop:py-4 md:py-4 bg-landing-brownLight-2 rounded-3xl">
            <div class="flex items-center">
                ...
                <div class="">
                    <h1 class="text-xs font-bold desktop:text-2xl laptop:text-xl md:text-md">PROSES MUDAH DAN AMAN</h1>
                    <p class="pr-2 text-xs font-normal tracking-tight desktop:text-2xl laptop:text-xl md:text-md lg:pr-50 md:pr-10 md:tracking-wider">Proses kami mudah, aman, dan terjamin dalam memastikan setiap tahap berjalan lancar dengan hasil sesuai harapan.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center px-5 mt-5 desktop:px-80 laptop:px-50 md:px-30">
        <div class="w-full px-5 py-4 border desktop:px-8 laptop:px-5 md:px-5 desktop:py-6 laptop:py-4 md:py-4 bg-landing-brownLight-1 rounded-3xl">
            <div class="flex items-center">
                ...
                <div class="">
                    <h1 class="text-xs font-bold desktop:text-2xl laptop:text-xl md:text-md">DOKUMENTASI PROYEK DAN PENDAMPINGAN</h1>
                    <p class="pr-2 text-xs font-normal tracking-tight desktop:text-2xl laptop:text-xl md:text-md lg:pr-50 md:pr-10 md:tracking-wider">Memastikan setiap tahap tercatat dengan jelas dan berjalan sesuai rencana.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center px-5 mt-5 desktop:px-80 laptop:px-50 md:px-30">
        <div class="w-full px-5 py-4 border desktop:px-8 laptop:px-5 md:px-5 desktop:py-6 laptop:py-4 md:py-4 bg-landing-brownLight-2 rounded-3xl">
            <div class="flex items-center">
                <div class="p-5 mx-2 border-0 rounded-full bg-theme3 desktop:p-6 laptop:p-5 md:p-5 lg:mx-5">
                    <svg viewBox="0 0 1024 1024" class="w-12 h-full desktop:w-14 laptop:w-12 md:w-12" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M182.87 146.29h585.14v292.57h73.14V73.14H109.72v877.72h402.29v-73.15H182.87z" fill="#c29844"></path><path d="M713.14 481.52L512 582.1v88.24c0 110.29 62.31 211.11 160.95 260.43l40.19 20.09 40.19-20.09c98.64-49.32 160.95-150.14 160.95-260.43V582.1L713.14 481.52z m128 188.81c0 83.12-46.18 157.84-120.52 195.01l-7.48 3.74-7.48-3.74c-74.34-37.17-120.52-111.9-120.52-195.01V627.3l128-64 128 64v43.03z" fill="#c29844"></path><path d="M657.87 683.21l-36.33 41.11 93.25 82.43 113.93-131.09-41.39-36L709.69 729zM256 256h438.86v73.14H256zM256 438.86h292.57V512H256zM256 621.71h146.29v73.14H256z" fill="#c29844"></path></g></svg>
                </div>
                <div class="">
                    <h1 class="text-xs font-bold desktop:text-2xl laptop:text-xl md:text-md">BERGARANSI</h1>
                    <p class="pr-2 text-xs font-normal tracking-tight desktop:text-2xl laptop:text-xl md:text-md lg:pr-50 md:pr-10 md:tracking-wider">Jasa kami dilengkapi garansi anti bocor dan retak struktur, memberikan jaminan ketahanan dan kualitas bangunan yang tahan lama.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="relative">
            <div class="border-0 desktop:w-[1000px] laptop:w-[700px] md:w-[500px] sm:w-[350px] w-[350px] desktop:h-[700px] laptop:h-[550px] md:h-[550px] h-[550px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 text-lg font-bold desktop:text-5xl laptop:text-3xl md:text-3xl text-landing-gold">MULAI 3,5 JUTA / M2</h1>
                    <p class="text-xs font-normal tracking-tight desktop:text-lg laptop:text-sm md:text-md text-landing-gold md:tracking-wider">*non-metropolitan (bukan kota besar)</p>
                </div>
                <div class="mx-10 mt-3 desktop:mx-20 laptop:mx-20 md:mx-20 desktop:mt-6 laptop:mt-3 md:mt-3">
                    <h3 class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">FASILITAS :</h3>
                    <ul class="">
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">FREE DESIGN DAN RANCANGAN ANGGARAN BIAYA (RAB)</p>
                        </li>
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEKERJAAN PONDASI</p>
                        </li>
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEKERJAAN STRUKTUR BAJA / BETON (SLOOF, KOLOM, BALOK, ATAP)</p>
                        </li>
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEKERJAAN ARSITEKTURAL (DINDING DAN ORNAMEN FASAD, LANTAI)</p>
                        </li>
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEKERJAAN MEP</p>
                        </li>
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEKERJAAN FINISHING (CAT, BATU ALAM, DLL)</p>
                        </li>
                    </ul>
                    <div class="mt-3">
                        <h3 class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">LAYANAN LAIN :</h3>
                        <ul class="">
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEMBUATAN KANOPI</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEMBUATAN LANSKAP (TAMAN, KOLAM IKAN)</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEMBUATAN PAGAR BESI</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEKERJAAN PAVING</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEMBUATAN KOLAM RENANG</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="absolute bottom-0 w-full px-5 py-5 border-0 rounded-full bg-theme2">
                <h1 class="text-xs font-bold text-center text-white desktop:text-2xl laptop:text-base md:text-xs">PILIH PAKET</h1>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center">
        <div class="relative">
            <div class="border-0 desktop:w-[1000px] laptop:w-[700px] md:w-[500px] sm:w-[350px] w-[350px] desktop:h-[700px] laptop:h-[550px] md:h-[550px] h-[550px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 text-lg font-bold desktop:text-5xl laptop:text-3xl md:text-3xl text-landing-gold">MULAI 2 JUTA / M2</h1>
                    <p class="text-xs font-normal tracking-tight desktop:text-lg laptop:text-sm md:text-md text-landing-gold md:tracking-wider">*non-metropolitan (bukan kota besar)</p>
                </div>
                <div class="mx-10 mt-3 desktop:mx-20 laptop:mx-20 md:mx-20 desktop:mt-6 laptop:mt-3 md:mt-3">
                    <h3 class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">FASILITAS :</h3>
                    <ul class="">
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">FREE DESIGN DAN RANCANGAN ANGGARAN BIAYA (RAB) SUPERVISI</p>
                        </li>
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">PEKERJAAN FURNITUR 1 RUANGAN</p>
                        </li>
                        <li class="ml-8 text-white list-disc">
                            <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">FREE PENGIRIMAN *S&K BERLAKU</p>
                        </li>
                    </ul>
                    <div class="mt-3 mb-5">
                        <h3 class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">LAYANAN LAIN :</h3>
                        <ul class="">
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">KITCHEN SET & MINI BAR</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">WALK IN CLOSET</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">LEMARI (LEMARI BAJU, ETALASE / DISPLAY)</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">BUFFET & CABINET</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">SOFA</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">DIVAN KASUR / TEMPAT TIDUR (SPRING BOX)</p>
                            </li>
                            <li class="ml-8 text-white list-disc">
                                <p class="text-xs text-white desktop:text-2xl laptop:text-base md:text-xs">MEJA CUSTOM (MEJA KANTOR, MEJA MEETING, MEJA KOMPUTER, MEJA RESEPSIONIS, MEJA MAKAN)</p>
                            </li>
                        </ul>
                    </div>
                </div>
     ...
     {{-- Carousel Slider --}}
    <div class="relative w-full my-5 desktop:my-70 laptop:my-40 lg:my-40 md:my-20 sm:my-10">
    ...
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <div class="flex items-center justify-center h-64 overflow-hidden rounded-2xl desktop:h-75 laptop:h-64 md:h-64">
