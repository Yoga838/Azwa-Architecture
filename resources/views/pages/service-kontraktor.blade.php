...
@section("content")
    ...
    <div class="2xl:mt-5 xl:mt-5 lg:mt-5 md:mt-5 mt-5 flex justify-center items-center 2xl:px-50 xl:px-30 lg:px-30 md:px-30 px-10">
        <div class="w-full border 2xl:px-8 xl:px-5 lg:px-5 md:px-5 px-5 2xl:py-6 xl:py-4 lg:py-4 md:py-4 py-4 bg-landing-brownLight-1 rounded-3xl">
            <div class="flex items-center">
                ...
                <div class="">
                    <h1 class="font-bold 2xl:text-2xl xl:text-xl lg:text-lg md:text-md text-xs">REKANAN TERPERCAYA (SUPERVISI OLEH ARSITEK DAN TEKNIK SIPIL)</h1>
                    <p class="font-normal 2xl:text-2xl xl:text-xl lg:text-lg md:text-md text-xs lg:pr-50 md:pr-10 pr-2 md:tracking-wider tracking-tight">Bekerjasama dengan rekanan terpercaya untuk memastikan setiap tahap pengerjaan bangunan memenuhi standar kualitas dan keamanan tertinggi.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="2xl:mt-5 xl:mt-5 lg:mt-5 md:mt-5 mt-5 flex justify-center items-center 2xl:px-50 xl:px-30 lg:px-30 md:px-30 px-10">
        <div class="w-full border 2xl:px-8 xl:px-5 lg:px-5 md:px-5 px-5 2xl:py-6 xl:py-4 lg:py-4 md:py-4 py-4 bg-landing-brownLight-1 rounded-3xl">
            <div class="flex items-center">
                ...
                <div class="">
                    <h1 class="font-bold 2xl:text-2xl xl:text-xl lg:text-lg md:text-md text-xs">DOKUMENTASI PROYEK DAN PENDAMPINGAN</h1>
                    <p class="font-normal 2xl:text-2xl xl:text-xl lg:text-lg md:text-md text-xs lg:pr-50 md:pr-10 pr-2 md:tracking-wider tracking-tight">Memastikan setiap tahap tercatat dengan jelas dan berjalan sesuai rencana.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="2xl:mt-5 xl:mt-5 lg:mt-5 md:mt-5 mt-5 flex justify-center items-center 2xl:px-50 xl:px-30 lg:px-30 md:px-30 px-10">
        <div class="w-full border 2xl:px-8 xl:px-5 lg:px-5 md:px-5 px-5 2xl:py-6 xl:py-4 lg:py-4 md:py-4 py-4 bg-landing-brownLight-2 rounded-3xl">
            <div class="flex items-center">
                <div class="border-0 bg-theme3 2xl:p-6 xl:p-5 lg:p-5 md:p-5 p-5 rounded-full lg:mx-5 mx-2">
                    <svg viewBox="0 0 1024 1024" class="2xl:w-14 xl:w-12 lg:w-12 md:w-12 w-12 h-full" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M182.87 146.29h585.14v292.57h73.14V73.14H109.72v877.72h402.29v-73.15H182.87z" fill="#c29844"></path><path d="M713.14 481.52L512 582.1v88.24c0 110.29 62.31 211.11 160.95 260.43l40.19 20.09 40.19-20.09c98.64-49.32 160.95-150.14 160.95-260.43V582.1L713.14 481.52z m128 188.81c0 83.12-46.18 157.84-120.52 195.01l-7.48 3.74-7.48-3.74c-74.34-37.17-120.52-111.9-120.52-195.01V627.3l128-64 128 64v43.03z" fill="#c29844"></path><path d="M657.87 683.21l-36.33 41.11 93.25 82.43 113.93-131.09-41.39-36L709.69 729zM256 256h438.86v73.14H256zM256 438.86h292.57V512H256zM256 621.71h146.29v73.14H256z" fill="#c29844"></path></g></svg>
                </div>
                <div class="">
                    <h1 class="font-bold 2xl:text-2xl xl:text-xl lg:text-lg md:text-md text-xs">BERGARANSI</h1>
                    <p class="font-normal 2xl:text-2xl xl:text-xl lg:text-lg md:text-md text-xs lg:pr-50 md:pr-10 pr-2 md:tracking-wider tracking-tight">Jasa kami dilengkapi garansi anti bocor dan retak struktur, memberikan jaminan ketahanan dan kualitas bangunan yang tahan lama.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="relative">
            <div class="border-0 2xl:w-[850px] xl:w-[600px] lg:w-[600px] md:w-[500px] sm:w-[350px] w-[350px] 2xl:h-[600px] xl:h-[550px] lg:h-[550px] md:h-[550px] h-[550px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 font-bold 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-lg text-landing-gold">MULAI 3,5 JUTA / M2</h1>
                    <p class="font-normal 2xl:text-md xl:text-sm lg:text-sm md:text-md text-xs text-landing-gold md:tracking-wider tracking-tight">*non-metropolitan (bukan kota besar)</p>
                </div>
                <div class="2xl:mx-20 xl:mx-20 lg:mx-20 md:mx-20 mx-10 2xl:mt-6 xl:mt-3 lg:mt-3 md:mt-3 mt-3">
                    <h3 class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">FASILITAS :</h3>
                    <ul class="">
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">FREE DESIGN DAN RANCANGAN ANGGARAN BIAYA (RAB)</p>
                        </li>
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEKERJAAN PONDASI</p>
                        </li>
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEKERJAAN STRUKTUR BAJA / BETON (SLOOF, KOLOM, BALOK, ATAP)</p>
                        </li>
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEKERJAAN ARSITEKTURAL (DINDING DAN ORNAMEN FASAD, LANTAI)</p>
                        </li>
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEKERJAAN MEP</p>
                        </li>
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEKERJAAN FINISHING (CAT, BATU ALAM, DLL)</p>
                        </li>
                    </ul>
                    <div class="mt-3">
                        <h3 class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">LAYANAN LAIN :</h3>
                        <ul class="">
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEMBUATAN KANOPI</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEMBUATAN LANSKAP (TAMAN, KOLAM IKAN)</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEMBUATAN PAGAR BESI</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEKERJAAN PAVING</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEMBUATAN KOLAM RENANG</p>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="flex justify-center items-center">
        <div class="relative">
            <div class="border-0 2xl:w-[850px] xl:w-[600px] lg:w-[600px] md:w-[500px] sm:w-[350px] w-[350px] 2xl:h-[600px] xl:h-[550px] lg:h-[550px] md:h-[550px] h-[550px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 font-bold 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-lg text-landing-gold">MULAI 2 JUTA / M2</h1>
                    <p class="font-normal 2xl:text-md xl:text-sm lg:text-sm md:text-md text-xs text-landing-gold md:tracking-wider tracking-tight">*non-metropolitan (bukan kota besar)</p>
                </div>
                <div class="2xl:mx-20 xl:mx-20 lg:mx-20 md:mx-20 mx-10 2xl:mt-6 xl:mt-3 lg:mt-3 md:mt-3 mt-3">
                    <h3 class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">FASILITAS :</h3>
                    <ul class="">
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">FREE DESIGN DAN RANCANGAN ANGGARAN BIAYA (RAB) SUPERVISI</p>
                        </li>
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">PEKERJAAN FURNITUR 1 RUANGAN</p>
                        </li>
                        <li class="list-disc text-white ml-8">
                            <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">FREE PENGIRIMAN *S&K BERLAKU</p>
                        </li>
                    </ul>
                    <div class="mt-3 mb-5">
                        <h3 class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">LAYANAN LAIN :</h3>
                        <ul class="">
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">KITCHEN SET & MINI BAR</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">WALK IN CLOSET</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">LEMARI (LEMARI BAJU, ETALASE / DISPLAY)</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">BUFFET & CABINET</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">SOFA</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">DIVAN KASUR / TEMPAT TIDUR (SPRING BOX)</p>
                            </li>
                            <li class="list-disc text-white ml-8">
                                <p class="text-white text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">MEJA CUSTOM (MEJA KANTOR, MEJA MEETING, MEJA KOMPUTER, MEJA RESEPSIONIS, MEJA MAKAN)</p>
                            </li>
                        </ul>
                    </div>
                </div>
     ...
     {{-- Carousel Slider --}}
    <div class="w-full relative 2xl:my-60 xl:my-40 lg:my-40 md:my-20 sm:my-10 my-5">
    <div class="swiper centered-slide-carousel swiper-container relative ">
    <div class="flex justify-center mb-10 2xl:visible xl:visible lg:invisible md:invisible sm:invisible invisible">
        <div class="flex items-center gap-3 mr-10">
            <div class="border bg-black-2 2xl:p-7 xl:p-5 lg:p-5 md:p-5 p-5 rounded-full"></div>
            <h1 class="font-semibold text-landing-brown-3 text-xs 2xl:text-xl xl:text-base lg:text-base md:text-xs">azwadesignstudio</h1>
        </div>
    </div>
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <div class="rounded-2xl 2xl:h-75 xl:h-64 lg:h-64 md:h-64 h-64 flex justify-center items-center overflow-hidden">
    ...
    <div class="flex justify-center mt-2 2xl:visible xl:visible lg:invisible md:invisible sm:invisible invisible">
        <button class="border bg-landing-brown-1 hover:bg-landing-brown-3 transition duration-300 ease-in-out transform hover:scale-105 2xl:px-9 xl:px-8 px-8 2xl:py-3 xl:py-2 py-2 rounded-full">
