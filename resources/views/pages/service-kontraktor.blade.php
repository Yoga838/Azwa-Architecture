...
@section("content")
    ...
    <div class="flex justify-center invisible mt-2 2xl:visible xl:visible lg:invisible md:invisible sm:invisible">
        <button class="px-8 py-2 transition duration-300 ease-in-out transform border rounded-full bg-landing-brown-1 hover:bg-landing-brown-3 hover:scale-105 2xl:px-9 xl:px-8 2xl:py-3 xl:py-2">
