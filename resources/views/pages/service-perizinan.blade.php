...
<div class="w-full h-full flex justify-center relative">
    ...
    <div class="py-32">
        <div class="mx-10">
            <p class="mt-20 text-start lg:text-6xl md:text-4xl text-2xl font-bold text-theme1 drop-shadow-2">
...
<h1 class="text-landing-gold text-xl lg:text-4xl md:text-2xl text-md font-bold text-center mt-10">KENAPA HARUS KAMI ?</h1>
{{-- CardTag --}}
...
<div class="flex justify-center items-center">
    <div class="relative">
        <div class="border-0 w-[350px] lg:w-[700px] md:w-[500px] sm:w-[350px] h-[250px] bg-theme3 rounded-[2rem] pt-5">
            <div class="text-center">
                <h1 class="mt-5 mb-10 font-bold lg:text-3xl text-lg text-landing-gold">MULAI 2 JUTA / 100 M2</h1>
            </div>
            <div class="lg:mx-20 md:mx-20 mx-10 mt-3">
                <ul class="">
                    <li class="list-disc text-white ml-8">
                        <p class="text-white text-xs lg:text-base">TIDAK TERMASUK BIAYA GAMBAR TEKNIS</p>
                    </li>
                    <li class="list-disc text-white ml-8">
                        <p class="text-white text-xs lg:text-base">PENDAMPINGAN SELAMA PENGURUSAN</p>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="flex justify-center items-center">
    <div class="relative">
        <div class="border-0 w-[350px] lg:w-[700px] md:w-[500px] sm:w-[350px] h-[300px] bg-theme3 rounded-[2rem] pt-5">
            <div class="text-center">
                <h1 class="mt-5 mb-10 font-bold lg:text-3xl text-lg text-landing-gold">MULAI 5 JUTA / 100 M2</h1>
            </div>
            <div class="lg:mx-20 md:mx-20 mx-10 mt-3">
                <ul class="">
                    <li class="list-disc text-white ml-8">
                        <p class="text-white text-xs lg:text-base">PROSES PERIZINAN</p>
                    </li>
                    <li class="list-disc text-white ml-8">
                        <p class="text-white text-xs lg:text-base">SEMUA DOKUMEN LENGKAP (GAMBAR TEKNIK, LAPORAN TEKNIS STRUKTUR)</p>
                    </li>
                    <li class="list-disc text-white ml-8">
                        <p class="text-white text-xs lg:text-base">PENDAMPINGAN SELAMA PENGURUSAN</p>
                    </li>
...
<div class="flex justify-center my-20">
    <div class="bg-theme2 flex items-center w-fill px-3 py-1 rounded-full">
