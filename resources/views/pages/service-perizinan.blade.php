...
<h1 class="text-landing-gold desktop:text-5xl laptop:text-4xl md:text-2xl text-md font-bold text-center desktop:mt-20 laptop:mt-10 lg:mt-10 md:mt-10 mt-10">KENAPA HARUS KAMI ?</h1>
{{-- CardTag --}}
<div class="desktop:mt-10 laptop:mt-5 md:mt-5 mt-5 flex justify-center items-center desktop:px-80 laptop:px-50 md:px-30 px-5">
