...
<div class="w-full h-full flex justify-center relative">
    ...
    <div data-aos="fade-left" data-aos-duration="1000" class="py-32">
        <div class="mx-10">
            <p class="desktop:mt-40 laptop:mt-20 md:mt-20 mt-20 text-start desktop:text-7xl laptop:text-6xl md:text-4xl text-2xl font-bold text-theme1 drop-shadow-2">
...
{{-- CardTag --}}
<div data-aos="fade-up" data-aos-duration="1000" class="desktop:mt-10 laptop:mt-5 md:mt-5 mt-5 flex justify-center items-center desktop:px-80 laptop:px-50 md:px-30 px-5">
    <div class="border w-full desktop:px-8 laptop:px-5 md:px-5 px-5 desktop:py-6 laptop:py-4 md:py-4 py-4 bg-landing-brownLight-2 rounded-3xl">
        <div class="flex items-center">
            <div class="border-0 bg-theme3 desktop:p-6 laptop:p-5 md:p-5 p-5 rounded-full lg:mx-5 mx-2">
                <svg viewBox="0 0 20 20" class="desktop:w-14 laptop:w-12 md:w-12 w-12 h-full" xmlns="http://www.w3.org/2000/svg" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="#c29844" fill-rule="evenodd" d="M3 10a7 7 0 019.307-6.611 1 1 0 00.658-1.889 9 9 0 105.98 7.501 1 1 0 00-1.988.22A7 7 0 113 10zm14.75-5.338a1 1 0 00-1.5-1.324l-6.435 7.28-3.183-2.593a1 1 0 00-1.264 1.55l3.929 3.2a1 1 0 001.38-.113l7.072-8z"></path> </g></svg>
            </div>
            <div class="">
                <h1 class="font-bold desktop:text-2xl laptop:text-xl md:text-md text-xs">SSK LENGKAP</h1>
                <p class="font-normal desktop:text-2xl laptop:text-xl md:text-md text-xs lg:pr-50 md:pr-10 pr-2 md:tracking-wider tracking-tight">Kami menyediakan layanan dengan langkah SKK (Surat Keterangan Kelayakan) lengkap.</p>
            </div>
        </div>
    </div>
</div>
...
<div data-aos="fade-up" data-aos-duration="1000" class="desktop:mt-10 laptop:mt-5 md:mt-5 mt-5 flex justify-center items-center desktop:px-80 laptop:px-50 md:px-30 px-5">
    <div class="border w-full desktop:px-8 laptop:px-5 md:px-5 px-5 desktop:py-6 laptop:py-4 md:py-4 py-4 bg-landing-brownLight-1 rounded-3xl">
        <div class="flex items-center">
            ...
            <div class="">
                <h1 class="font-bold desktop:text-2xl laptop:text-xl md:text-md text-xs">PELUNASAN SETELAH JADI</h1>
                <p class="font-normal desktop:text-2xl laptop:text-xl md:text-md text-xs lg:pr-50 md:pr-10 pr-2 md:tracking-wider tracking-tight">Menggunakan sistem pelunasan setelah proses selesai, memberikan kepercayaan penuh pada Anda.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="desktop:mt-70 laptop:mt-50 md:mt-50 mt-50 w-full h-full flex items-center relative">
    ...
    <div data-aos="fade-left" data-aos-duration="1000" class="py-20 mt-30">
        <h1 class="font-bold text-2xl desktop:text-6xl laptop:text-5xl md:text-4xl text-theme1 drop-shadow-2 md:ml-21">PBG (Persetujuan Bangunan Gedung) / <br>SLF ( Sertifikasi Layak Fungsi)</h1>
    </div>
</div>
{{-- Card --}}
<div data-aos="fade-up" data-aos-duration="1000" class="flex justify-center items-center">
    <div class="relative">
        <div class="border-0 desktop:w-[900px] laptop:w-[700px] md:w-[500px] sm:w-[350px] w-[350px] desktop:h-[300px] laptop:h-[250px] md:h-[250px] h-[250px] bg-theme3 rounded-[2rem] pt-5">
            <div class="text-center">
                <h1 class="mt-5 mb-10 font-bold desktop:text-5xl laptop:text-3xl md:text-3xl text-lg text-landing-gold">MULAI 2 JUTA / 100 M2</h1>
            </div>
            <div class="desktop:mx-20 laptop:mx-20 md:mx-20 mx-10 desktop:mt-6 laptop:mt-3 md:mt-3 mt-3">
                <ul class="">
                    <li class="list-disc text-white ml-8">
                        <p class="text-white text-xs desktop:text-2xl laptop:text-base md:text-xs">TIDAK TERMASUK BIAYA GAMBAR TEKNIS</p>
                    </li>
                    <li class="list-disc text-white ml-8">
                        <p class="text-white text-xs desktop:text-2xl laptop:text-base md:text-xs">PENDAMPINGAN SELAMA PENGURUSAN</p>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="desktop:mt-70 laptop:mt-50 md:mt-50 mt-50 w-full h-full flex items-center relative">
    ...
    <div data-aos="fade-left" data-aos-duration="1000" class="py-20 mt-30">
        <h1 class="font-bold text-2xl desktop:text-6xl laptop:text-5xl md:text-4xl text-theme1 drop-shadow-2 md:ml-21">PAKET LENGKAP PBG & SLF</h1>
    </div>
</div>
{{-- Card --}}
<div data-aos="fade-up" data-aos-duration="1000" class="flex justify-center items-center">
    <div class="relative">
        <div class="border-0 desktop:w-[1100px] laptop:w-[800px] md:w-[500px] sm:w-[350px] w-[350px] desktop:h-[350px] laptop:h-[300px] md:h-[300px] h-[300px] bg-theme3 rounded-[2rem] pt-5">
            <div class="text-center">
                <h1 class="mt-5 mb-10 font-bold desktop:text-5xl laptop:text-3xl md:text-3xl text-lg text-landing-gold">MULAI 5 JUTA / 100 M2</h1>
            </div>
            <div class="lg:mx-20 md:mx-20 mx-10 mt-3">
                <ul class="">
                    <li class="list-disc text-white ml-8">
                        <p class="text-white desktop:text-2xl laptop:text-base md:text-xs">PROSES PERIZINAN</p>
                    </li>
                    <li class="list-disc text-white ml-8">
                        <p class="text-white desktop:text-2xl laptop:text-base md:text-xs">SEMUA DOKUMEN LENGKAP (GAMBAR TEKNIK, LAPORAN TEKNIS STRUKTUR)</p>
                    </li>
                    <li class="list-disc text-white ml-8">
                        <p class="text-white desktop:text-2xl laptop:text-base md:text-xs">PENDAMPINGAN SELAMA PENGURUSAN</p>
                    </li>
                </ul>
            </div>
        </div>
        <div class="absolute bottom-0 border-0 px-5 py-5 w-full rounded-full bg-theme2">
            <h1 class="text-white font-bold text-center desktop:text-2xl laptop:text-base md:text-xs">PILIH PAKET</h1>
        </div>
    </div>
</div>


<div data-aos="fade-up" data-aos-duration="1000" class="flex justify-center my-20">
    <div class="bg-theme2 flex items-center w-fill desktop:px-6 laptop:px-3 md:px-3 px-3 desktop:py-2 laptop:py-1 md:py-1 py-1 rounded-full">
      ...
      <p class="text-sm desktop:text-2xl laptop:text-xl md:text-xl font-medium pb-1 pl-3">
