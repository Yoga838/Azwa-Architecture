...
@section("content")
    ...
    <h1 class="py-10 text-3xl lg:text-5xl font-bold tracking-wide text-theme3 text-center">Bandingkan dan Pilih Paket Anda</h1>
    ...
    {{-- Promo Card Slider --}} 
    <div class="w-full relative px-5 lg:px-36">
        ...
        <div class="px-10 lg:px-36 pt-10 min-w-[1024px] relative z-10">
            ...
            <div class="grid grid-cols-5 mt-14">
                ...
                <div class="text-center">
                    ...
                    <p class="text-white mt-4">Penyerahan<br>Dokumen Hasil</p>
                </div>
                <div class="text-center">
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mb-3 relative">
                    ...
                    <p class="text-white mt-4">Pengerjaan<br>Gambar Kerja & RAB</p>
                </div>
                <div class="text-center">
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mb-3 relative">
                ...
                .then(response => {
                    ...
                    const promoCards = promos.map(promo => {
                        ...
                        <div class="swiper-slide">
                            <div class="border-6 border-black rounded-2xl h-96 overflow-hidden relative">
                                ...
                                <div class="flex z-[9]">
                                    <div class="p-8">
                                        <h1 class="text-lg lg:text-3xl text-landing-brown-2 font-bold">${promo.title}</h1>
                                        <div class="text-lg font-bold tracking-wider">
                                            <span class="line-through decoration-2 decoration-landing-brown-2">Rp. ${parseFloat(promo.actual_price).toLocaleString('id-ID')}</span>
                                        </div>
                                        <h1 class="text-3xl lg:text-5xl text-landing-brown-2 font-bold">Rp. ${parseFloat(promo.price).toLocaleString('id-ID')}</h1>
                                        <ul class="mt-4 my-2">
                                            ${descriptionList.map(item => `<li class="text-base lg:text-lg text-landing-brown-1 font-bold">${item}</li>`).join('')}
                                        </ul>
                                    </div>
                                </div>
                            </div>
