...
@section("content")
    ...
    <div class="pt-15 w-full h-full flex items-center relative">
        ...
        <div class="py-10 desktop:py-30 mt-30">
            <h1 class="font-bold text-5xl desktop:text-7xl text-theme1 drop-shadow-2 ml-20 desktop:ml-40 tracking-wider">Arsitektur</h1>
        </div>
    </div>
    {{-- Card Arsitektur --}}
    <div class="flex flex-wrap justify-center gap-4">
        ...
        <div class="relative">
            <div class="border-0 w-[300px] desktop:w-[700px] lg:w-[500px] md:w-[300px] sm:w-[300px] h-[500px] desktop:h-[700px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 font-extrabold desktop:text-5xl lg:text-4xl text-lg text-landing-gold">BRONZE</h1>
                    <h1 class="font-medium desktop:text-5xl lg:text-4xl text-lg text-landing-gold tracking-wider">100.000 / M2</h1>
                </div>
                <div class="lg:mx-10 md:mx-10 mx-5 mt-10">
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">DENAH 2D DAN 3D (2X REVISI)</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">3D RENDER EKSTERIOR (ALL VIEW & 2X REVISI)</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">GAMBAR KERJA ARSITEKTUR</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">GAMBAR KERJA STRUKTUR</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">GAMBAR KERJA MEP</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">RANCANGAN ANGGARAN BIAYA (RAB)</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">UPAH KERJA & MATERIAL</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="absolute bottom-0 border-0 px-5 py-5 w-full rounded-full bg-theme2">
                <h1 class="text-white font-bold text-center text-lg laptop:text-xl desktop:text-3xl">PILIH PAKET</h1>
            </div>
        </div>
        ...
        <div class="relative">
            <div class="border-0 w-[300px] desktop:w-[700px] lg:w-[500px] md:w-[300px] sm:w-[300px] h-[500px] desktop:h-[700px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 font-extrabold desktop:text-5xl lg:text-4xl text-lg text-landing-gold">GOLD</h1>
                    <h1 class="font-medium desktop:text-5xl lg:text-4xl text-lg text-landing-gold tracking-wider">150.000 / M2</h1>
                </div>
                <div class="lg:mx-10 md:mx-10 mx-5 mt-10">
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="list-disc text-white">
                        ...
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">LAYOUT PRESENTATION + 3D MODEL</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">GAMBAR KERJA ARSITEKTUR</p>
                        </li>
                        ...
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">VIDEO 3D</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">DOKUMEN HARDFILE DAN SOFTFILE</p>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="mt-50 w-full h-full flex items-center relative">
        ...
        <div class="py-10 desktop:py-30 mt-30">
            <h1 class="font-bold text-5xl desktop:text-7xl text-theme1 drop-shadow-2 ml-20 desktop:ml-40 tracking-wider">Desain Interior</h1>
        </div>
    </div>
    ...
    <div class="flex flex-wrap justify-center gap-4">
        ...
        <div class="relative">
            <div class="border-0 w-[300px] desktop:w-[600px] lg:w-[370px] sm:w-[300px] h-[500px] desktop:h-[700px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 font-extrabold desktop:text-5xl lg:text-4xl text-lg text-landing-gold">DELUXE</h1>
                    <h1 class="font-medium desktop:text-5xl lg:text-4xl text-lg text-landing-gold tracking-wider">150.000 / M2</h1>
                </div>
                <div class="lg:mx-10 md:mx-10 mx-5 mt-10">
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">LAYOUT DENAH 2D</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">3D RENDER INTERIOR (ALL VIEW)</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">DETAIL INTERIOR (GAMBAR KERJA & SPESIFIKASI MATERIAL)</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">3D MOODBOARD</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">RANCANGAN ANGGARAN BIAYA (RAB)</p>
                        </li>
        ...
        <div class="relative">
            <div class="border-0 w-[300px] desktop:w-[600px] lg:w-[370px] sm:w-[300px] h-[500px] desktop:h-[700px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 font-extrabold desktop:text-5xl lg:text-4xl text-lg text-landing-gold">PREMIUM</h1>
                    <h1 class="font-medium desktop:text-5xl lg:text-4xl text-lg text-landing-gold tracking-wider">200.000 / M2</h1>
                </div>
                <div class="lg:mx-10 md:mx-10 mx-5 mt-10">
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="list-disc text-white">
                        ...
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">3D VIDEO RENDER (TOUR VIEW)</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">DOKUMEN HARDFILE DAN SOFTFILE</p>
                        </li>
    ...
    <div class="mt-50 w-full h-full flex items-center relative">
        ...
        <div class="py-10 desktop:py-30 mt-30">
            <h1 class="font-bold text-5xl desktop:text-7xl text-theme1 drop-shadow-2 ml-20 desktop:ml-40 tracking-wider">Arsitektur Interior</h1>
        </div>
    </div>
    {{-- Card Desain Interior --}}
    <div class="flex flex-wrap justify-center gap-4">
        ...
        <div class="relative">
            <div class="border-0 w-[300px] desktop:w-[650px] lg:w-[500px] md:w-[300px] sm:w-[300px] h-[700px] desktop:h-[900px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 font-extrabold desktop:text-5xl lg:text-4xl text-lg text-landing-gold">PLATINUM</h1>
                    <h1 class="font-medium desktop:text-5xl lg:text-4xl text-lg text-landing-gold tracking-wider">250.000 / M2</h1>
                </div>
                <div class="lg:mx-10 md:mx-10 mx-5 mt-10">
                    <h3 class="text-white font-semibold text-normal desktop:text-2xl">ARSITEKTUR :</h3>
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">DENAH 2D DAN 3D (2X REVISI)</p>
                        </li>
                    ...
                    <h3 class="mt-5 text-white font-semibold text-normal desktop:text-2xl">INTERIOR :</h3>
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">3D RENDER INTERIOR (ALL VIEW)</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">GAMBAR KERJA & SPESIFIKASI MATERIAL</p>
                        </li>
                        <li class="list-disc text-white">
                            <p class="text-white text-xs lg:text-base desktop:text-2xl">3D MOODBOARD</p>
                        </li>
        ...
        <div class="relative">
            <div class="border-0 w-[300px] desktop:w-[650px] lg:w-[500px] md:w-[300px] sm:w-[300px] h-[700px] desktop:h-[900px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 font-extrabold desktop:text-5xl lg:text-4xl text-lg text-landing-gold">PLATINUM PLUS</h1>
                    <h1 class="font-medium desktop:text-5xl lg:text-4xl text-lg text-landing-gold tracking-wider">325.000 / M2</h1>
                </div>
                <div class="lg:mx-10 md:mx-10 mx-5 mt-10">
                    <h3 class="text-white font-semibold text-normal desktop:text-2xl">ARSITEKTUR :</h3>
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
    ...
    <h1 class="py-10 text-3xl lg:text-5xl desktop:text-6xl font-bold tracking-wide text-theme3 text-center">Bandingkan dan Pilih Paket Anda</h1>

    </div>
    @include('components.tabel-paket.tabel-paket')
      
    <div class="flex justify-center mt-10">
        <button class="w-64 desktop:w-96 flex justify-center items-center py-2 desktop:py-4 px-2 desktop:px-4 rounded-full bg-theme2 text-landing-black-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="text-white w-6 h-6 desktop:w-10 desktop:h-10" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M19.05 4.91A9.82 9.82 0 0 0 12.04 2c-5.46 0-9.91 4.45-9.91 9.91c0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21c5.46 0 9.91-4.45 9.91-9.91c0-2.65-1.03-5.14-2.9-7.01m-7.01 15.24c-1.48 0-2.93-.4-4.2-1.15l-.3-.18l-3.12.82l.83-3.04l-.2-.31a8.26 8.26 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24c2.2 0 4.27.86 5.82 2.42a8.18 8.18 0 0 1 2.41 5.83c.02 4.54-3.68 8.23-8.22 8.23m4.52-6.16c-.25-.12-1.47-.72-1.69-.81c-.23-.08-.39-.12-.56.12c-.17.25-.64.81-.78.97c-.14.17-.29.19-.54.06c-.25-.12-1.05-.39-1.99-1.23c-.74-.66-1.23-1.47-1.38-1.72c-.14-.25-.02-.38.11-.51c.11-.11.25-.29.37-.43s.17-.25.25-.41c.08-.17.04-.31-.02-.43s-.56-1.34-.76-1.84c-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.43.06-.66.31c-.22.25-.86.85-.86 2.07s.89 2.4 1.01 2.56c.12.17 1.75 2.67 4.23 3.74c.59.26 1.05.41 1.41.52c.59.19 1.13.16 1.56.1c.48-.07 1.47-.6 1.67-1.18c.21-.58.21-1.07.14-1.18s-.22-.16-.47-.28"/></svg>
    ...
    {{-- Promo Card Slider --}} 
    <div class="w-full relative px-5 lg:px-36 laptop:px-40 desktop:px-52">
    ...
    {{-- Flow Step --}}
    <div class="w-screen mt-10 overflow-x-auto overflow-y-hidden bg-cover bg-center relative rounded" style="background-image:url('{{asset('assets/img/service/desain/bg-alurrencana.png')}}')">
        ...
        <div class="px-10 lg:px-36 py-20 min-w-[1024px] relative z-10">
            <div class="flex items-center">
                <h1 class="text-white text-2xl lg:text-5xl desktop:text-7xl font-bold me-5">Alur Kerja Perencanaan</h1>
                <div class="flex-1">
            ...
            <div class="grid grid-cols-5 mt-20">
                <div class="text-center">
                    <div class="w-20 h-20 desktop:w-28 desktop:h-28 bg-white rounded-full mx-auto flex items-center justify-center">
                        {{-- icon --}}
                    ...
                    <p class="text-white mt-4 text-base laptop:text-xl desktop:text-2xl">Konsultasi Gratis<br>& Pemilihan Paket</p>
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mt-3 relative">
                        <div class="w-8 h-8 desktop:w-14 desktop:h-14 bg-white rounded-full flex justify-center items-center">
                            <span class="text-black font-bold text-sm laptop:text-lg desktop:text-xl">1</span>
                        </div>
                        {{-- garis horizontal --}}
                ...
                <div class="text-center">
                    <div class="w-20 h-20 desktop:w-28 desktop:h-28 bg-yellow-500 rounded-full mx-auto flex items-center justify-center">
                        {{-- icon --}}
                    ...
                    <p class="text-white mt-4 text-base laptop:text-xl desktop:text-2xl">Pembayaran<br>Uang Muka</p>
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mt-3 relative">
                        <div class="w-8 h-8 desktop:w-14 desktop:h-14 bg-yellow-500 rounded-full flex justify-center items-center">
                            <span class="text-black font-bold text-sm laptop:text-lg desktop:text-xl">2</span>
                        </div>
                        {{-- garis horizontal --}}
                        <div class="absolute w-full z-[-1] h-1 desktop:h-2 bg-white top-1/2 left-1/2 transform translate-y-[-50%]"></div>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-white mt-4 text-base laptop:text-xl desktop:text-2xl">Diskusi dan<br>pengerjaan denah</p>
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mt-3 relative">
                        <div class="w-8 h-8 desktop:w-14 desktop:h-14 bg-white rounded-full flex justify-center items-center">
                            <span class="text-black font-bold text-sm laptop:text-lg desktop:text-xl">3</span>
                        </div>
                        {{-- garis horizontal --}}
                        <div class="absolute w-full z-[-1] h-1 desktop:h-2 bg-white top-1/2 left-1/2 transform translate-y-[-50%]"></div>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-white mt-4 text-base laptop:text-xl desktop:text-2xl">Pembayaran<br>Tahap Kedua</p>
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mt-3 relative">
                        <div class="w-8 h-8 desktop:w-14 desktop:h-14 bg-yellow-500 rounded-full flex justify-center items-center">
                            <span class="text-black font-bold text-sm laptop:text-lg desktop:text-xl">4</span>
                        </div>
                        {{-- garis horizontal --}}
                        <div class="absolute w-full z-[-1] h-1 desktop:h-2 bg-white top-1/2 left-1/2 transform translate-y-[-50%]"></div>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-white mt-4 text-base laptop:text-xl desktop:text-2xl">Pengerjaan<br>desain 3D</p>
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mt-3 relative">
                        <div class="w-8 h-8 desktop:w-14 desktop:h-14 bg-white rounded-full flex justify-center items-center">
                            <span class="text-black font-bold text-sm laptop:text-lg desktop:text-xl">5</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-5 mt-30">
                ...
                <div class="text-center">
                    ...
                    <div class="flex justify-center items-center mb-3 relative">
                        <div class="w-8 h-8 desktop:w-14 desktop:h-14 bg-yellow-500 rounded-full flex justify-center items-center">
                            <span class="text-black font-bold text-sm laptop:text-lg desktop:text-xl">8</span>
                        </div>
                        {{-- garis horizontal --}}
                        <div class="absolute w-full z-[-1] h-1 desktop:h-2 bg-white top-1/2 left-1/2 transform translate-y-[-50%]"></div>
                    </div>
                    ...
                    <p class="text-white mt-4 text-base laptop:text-xl desktop:text-2xl">Penyerahan<br>Dokumen Hasil</p>
                </div>
                <div class="text-center">
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mb-3 relative">
                        <div class="w-8 h-8 desktop:w-14 desktop:h-14 bg-white rounded-full flex justify-center items-center">
                            <span class="text-black font-bold text-sm laptop:text-lg desktop:text-xl">7</span>
                        </div>
                        {{-- garis horizontal --}}
                        <div class="absolute w-full z-[-1] h-1 desktop:h-2 bg-white top-1/2 left-1/2 transform translate-y-[-50%]"></div>
                    </div>
                    ...
                    <p class="text-white mt-4 text-base laptop:text-xl desktop:text-2xl">Pengerjaan<br>Gambar Kerja & RAB</p>
                </div>
                <div class="text-center">
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mb-3 relative">
                        <div class="w-8 h-8 desktop:w-14 desktop:h-14 bg-yellow-500 rounded-full flex justify-center items-center">
                            <span class="text-black font-bold text-sm laptop:text-lg desktop:text-xl">6</span>
                        </div>
                        {{-- garis horizontal --}}
                        <div class="absolute w-full z-[-1] h-1 desktop:h-2 bg-white top-1/2 left-1/2 transform translate-y-[-50%]"></div>
                    </div>
                    ...
                    <p class="text-white mt-4 text-base laptop:text-xl desktop:text-2xl">Pembayaran<br>Tahap Ketiga</p>
                </div>
                <div class="text-center">
                    {{-- nomor --}}
                    <div class="flex justify-center items-center mb-3 relative">
                            ...
                            <div class="border-6 border-black rounded-[44px] h-[500px] desktop:h-[600px] overflow-hidden relative">
                                ...
                                <div class="flex z-[9]">
                                    <div class="p-8 desktop:p-12">
                                        <h1 class="text-lg lg:text-3xl laptop:text-4xl desktop:text-5xl text-landing-brown-2 font-extrabold tracking-wide uppercase">${promo.title}</h1>
                                        <div class="text-lg laptop:text-3xl desktop:text-4xl font-extrabold tracking-wider my-2">
                                        ...
                                        <h1 class="text-3xl lg:text-4xl laptop:text-5xl desktop:text-6xl text-landing-brown-2 font-bold">Rp. ${parseFloat(promo.price).toLocaleString('id-ID')}</h1>
                                        <ul class="mt-4 my-2">
                                            ${descriptionList.map(item => `<li class="text-base lg:text-lg desktop:text-xl text-landing-black-1 font-bold tracking-wider">${item}</li>`).join('')}
                                        </ul>
                                        <div class="mt-10 flex">
                                            <button class="px-4 py-1 text-xl font-extrabold text-landing-black-1 transition duration-300 border-4 border-opacity-40 rounded-full tracking-wider bg-landing-brown-2 bg-opacity-40 border-black-2">
                                                Dapatkan Promo!
                                            </button>
                                        </div>
                                    </div>
