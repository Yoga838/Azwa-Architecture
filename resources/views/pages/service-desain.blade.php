...
@section("content")
    ...
    {{-- Promo Card Slider --}} 
    <div class="w-full relative mt-25 px-5 lg:px-36">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <div class="border-6 border-black rounded-2xl h-96 overflow-hidden relative">
                        ...
                        <div class="flex z-[9]">
                            <div class="p-8">
                                <h1 class="text-lg lg:text-3xl text-landing-brown-2 font-bold">PROMO ARSITEKTUR</h1>
                                ...
                                <h1 class="text-3xl lg:text-5xl text-landing-brown-2 font-bold">Rp. 35.000/m2</h1>
                                <ul class="mt-4 my-2">
                                    <li class="text-base lg:text-lg text-landing-brown-1 font-bold">Denah 2D</li>
                                    <li class="text-base lg:text-lg text-landing-brown-1 font-bold">Tampak Eksterior Render 3D (4+Tampak)</li>
                                    <li class="text-base lg:text-lg text-landing-brown-1 font-bold">Gambar Kerja Arsitektur</li>
                                    <li class="text-base lg:text-lg text-landing-brown-1 font-bold">Gambar Kerja Struktur</li>
                                    <li class="text-base lg:text-lg text-landing-brown-1 font-bold">Gambar Kerja MEP</li>
                                    <li class="text-base lg:text-lg text-landing-brown-1 font-bold"><span class="text-base lg:text-lg text-landing-brown-2 font-extrabold me-2">BONUS</span>Rancangan Anggaran Biaya (RAB) + Upah Kerja dan Material</li>
                                </ul>
                            </div>
                        </div>
                    </div>
