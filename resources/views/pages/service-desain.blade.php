...
@section("content")
    ...
    <div class="flex flex-wrap justify-center gap-9" style="font-family: Poppins, sans-serif;">
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="relative">
            <div class="border-0 w-[300px] 2xl:w-[550px] lg:w-[500px] md:w-[300px] sm:w-[300px] h-[500px] 2xl:h-[550px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 text-lg font-extrabold 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">BRONZE</h1>
                    <h1 class="text-lg font-medium tracking-wider 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">100.000 / M2</h1>
                </div>
                <div class="mx-5 mt-10 lg:mx-10 md:mx-10">
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">DENAH 2D DAN 3D (2X REVISI)</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">3D RENDER EKSTERIOR (ALL VIEW & 2X REVISI)</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">GAMBAR KERJA ARSITEKTUR</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">GAMBAR KERJA STRUKTUR</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">GAMBAR KERJA MEP</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">RANCANGAN ANGGARAN BIAYA (RAB)</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">UPAH KERJA & MATERIAL</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="relative">
            <div class="border-0 w-[300px] 2xl:w-[550px] lg:w-[500px] md:w-[300px] sm:w-[300px] h-[500px] 2xl:h-[550px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 text-lg font-extrabold 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">GOLD</h1>
                    <h1 class="text-lg font-medium tracking-wider 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">150.000 / M2</h1>
                </div>
                <div class="mx-5 mt-10 lg:mx-10 md:mx-10">
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="text-white list-disc">
                        ...
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">LAYOUT PRESENTATION + 3D MODEL</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">GAMBAR KERJA ARSITEKTUR</p>
                        </li>
                        ...
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">VIDEO 3D</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">DOKUMEN HARDFILE DAN SOFTFILE</p>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="flex flex-wrap justify-center gap-9" style="font-family: Poppins, sans-serif;">
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="relative">
            <div class="border-0 w-[300px] 2xl:w-[400px] lg:w-[400px] md:w-[300px] sm:w-[300px] h-[500px] 2xl:h-[550px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 text-lg font-extrabold 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">DELUXE</h1>
                    <h1 class="text-lg font-medium tracking-wider 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">150.000 / M2</h1>
                </div>
                <div class="mx-5 mt-10 lg:mx-10 md:mx-10">
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">LAYOUT DENAH 2D</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">3D RENDER INTERIOR (ALL VIEW)</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">DETAIL INTERIOR (GAMBAR KERJA & SPESIFIKASI MATERIAL)</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">3D MOODBOARD</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">RANCANGAN ANGGARAN BIAYA (RAB)</p>
                        </li>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="relative">
            <div class="border-0 w-[300px] 2xl:w-[400px] lg:w-[400px] md:w-[300px] sm:w-[300px] h-[500px] 2xl:h-[550px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 text-lg font-extrabold 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">PREMIUM</h1>
                    <h1 class="text-lg font-medium tracking-wider 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">200.000 / M2</h1>
                </div>
                <div class="mx-5 mt-10 lg:mx-10 md:mx-10">
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="text-white list-disc">
                        ...
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">3D VIDEO RENDER (TOUR VIEW)</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">DOKUMEN HARDFILE DAN SOFTFILE</p>
                        </li>
    ...
    <div class="flex flex-wrap justify-center gap-9" style="font-family: Poppins, sans-serif;">
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="relative">
            <div class="border-0 w-[300px] 2xl:w-[600px] lg:w-[500px] md:w-[300px] sm:w-[300px] h-[700px] 2xl:h-[800px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 text-lg font-extrabold 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">PLATINUM</h1>
                    <h1 class="text-lg font-medium tracking-wider 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">250.000 / M2</h1>
                </div>
                <div class="mx-5 mt-10 lg:mx-10 md:mx-10">
                    <h3 class="font-semibold text-white text-normal 2xl:text-2xl">ARSITEKTUR :</h3>
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">DENAH 2D DAN 3D (2X REVISI)</p>
                        </li>
                    ...
                    <h3 class="mt-5 font-semibold text-white text-normal 2xl:text-2xl">INTERIOR :</h3>
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">3D RENDER INTERIOR (ALL VIEW)</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">GAMBAR KERJA & SPESIFIKASI MATERIAL</p>
                        </li>
                        <li class="text-white list-disc">
                            <p class="text-xs text-white 2xl:text-xl xl:text-base lg:text-base md:text-xs">3D MOODBOARD</p>
                        </li>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="relative">
            <div class="border-0 w-[300px] 2xl:w-[600px] lg:w-[500px] md:w-[300px] sm:w-[300px] h-[700px] 2xl:h-[800px] bg-theme3 rounded-[2rem] pt-5">
                <div class="text-center">
                    <h1 class="mt-5 text-lg font-extrabold 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">PLATINUM PLUS</h1>
                    <h1 class="text-lg font-medium tracking-wider 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-3xl text-landing-gold">325.000 / M2</h1>
                </div>
                <div class="mx-5 mt-10 lg:mx-10 md:mx-10">
                    <h3 class="font-semibold text-white text-normal 2xl:text-2xl">ARSITEKTUR :</h3>
                    <ul class="ml-8 sm:ml-5 lg:ml-0">
                ...
                @if ($promo->count() === "0")
                    <div class="flex items-center justify-center w-full">
                        <div class="px-6 py-3 border rounded-full bg-theme3">
                            <h1 class="font-bold text-center sm:text-lg md:text-xl lg:text-2xl 2xl:text-3xl text-landing-body">
                                Oops.. masih belum ada promo nih!<br>Stay tune teruss yaa...
                            </h1>
                        </div>
                    </div>
                @else
                    @foreach ($promo as $item)
                        @php
                            ...
                            $firstColumn = array_slice($descriptionList, 0, 9); // Kolom kiri selalu maksimal 10
                            $secondColumn = array_slice($descriptionList, 9);   // Sisanya ke kolom kanan
                        @endphp
        ...
        <div data-aos="fade-up" data-aos-delay="1000" data-aos-duration="1000" class="px-10 lg:px-36 py-20 min-w-[1024px] relative z-10">
            ...
            <div class="grid grid-cols-5 mt-20" style="font-family: Poppins, sans-serif;">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-4 text-base text-white">Pembayaran<br>Tahap Kedua</p>
                    {{-- nomor --}}
                    <div class="relative flex items-center justify-center mt-3">
                        <div class="flex items-center justify-center w-8 h-8 bg-yellow-500 rounded-full">
            ...
            <div class="grid grid-cols-5 mt-30" style="font-family: Poppins, sans-serif;">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-4 text-base text-white">Pembayaran<br>Tahap Ketiga</p>
                </div>
                <div class="text-center">
                    {{-- nomor --}}
                    <div class="relative flex items-center justify-center mb-3">
                        <div class=""></div>
                        {{-- garis horizontal --}}
                        <div class="absolute w-[140px] z-[-1] h-1 bg-white top-[-54px] left-1/2 transform translate-x-[-50%] rotate-90"></div>
                    </div>
                </div>
            </div>
        </div>
