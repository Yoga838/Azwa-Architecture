    ...
    <div class="flex flex-col sm:flex-row bg-#e1dfd4">
      ...
      <div class="flex flex-col w-screen sm:w-7/12 my-auto md:ml-5 items-center" data-aos="fade-left" data-aos-delay="1000" data-aos-duration="1000">
        ...
        <div class="px-5 pb-10">
          ...
          <div class="bg-theme2 flex items-center w-fit px-5 rounded-full hover:bg-[#8B6F47] transition duration-300">
            ...
            <p class="md:text-xl lg:text-2xl font-medium pb-1 pl-3">
              <a href="mailto:azwakaryatama@gmail.com" class="text-theme1">azwakaryatama@gmail.com</a>
            </p>
          </div>
